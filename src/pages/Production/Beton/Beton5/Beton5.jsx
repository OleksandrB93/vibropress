...
export default function Beton5() {
  return (
    <ProductionContainer>
      <div>
      ...
      <div>
        ...
        <ProductionText>
          <strong>Вібросито, має такі переваги як:</strong>
        </ProductionText>
        ...
        <ProductionText>
          - досить низький рівень динамічного навантаження на основу.
        </ProductionText>
        <ProductionText>
          <strong>Технічна характеристика обладнання:</strong>
        </ProductionText>
        <ProductionText>
        ...
        <PtoductionImg>
          <img
            src={
              process.env.PUBLIC_URL + '/imgs/production/beton/beton5/51.jpg'
            }
            alt="Бетонозмішувач "
          />
